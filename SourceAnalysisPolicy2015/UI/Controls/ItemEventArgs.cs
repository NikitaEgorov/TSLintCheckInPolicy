//--------------------------------------------------------------------------
// <copyright file="ItemEventArgs.cs" company="Ralph Jansen">
...
namespace RalphJansen.StyleCopCheckInPolicy.UI.Controls
{
    ...
    internal class ItemEventArgs : CancelEventArgs
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RalphJansen.StyleCopCheckInPolicy.UI.Controls.ItemEventArgs"/> class.
        /// </summary>
