//--------------------------------------------------------------------------
// <copyright file="ComboBoxItem.cs" company="Ralph Jansen">
...
namespace RalphJansen.StyleCopCheckInPolicy.UI.Forms
{
    ...
    internal sealed class ComboBoxItem
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RalphJansen.StyleCopCheckInPolicy.UI.Forms.ComboBoxItem"/> class.
        /// </summary>
