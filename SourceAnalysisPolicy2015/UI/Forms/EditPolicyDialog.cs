//--------------------------------------------------------------------------
// <copyright file="EditPolicyDialog.cs" company="Ralph Jansen">
...
namespace RalphJansen.StyleCopCheckInPolicy.UI.Forms
{
    ...
    using RalphJansen.StyleCopCheckInPolicy.UI.Controls;
    using RalphJansen.StyleCopCheckInPolicy.UI.Forms.Design;
    using RalphJansen.StyleCopCheckInPolicy.UI.Forms.Editors;
    using RalphJansen.StyleCopCheckInPolicy.UI.Forms.Editors.Design;
    ...
    internal sealed partial class EditPolicyDialog : BaseDialog
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RalphJansen.StyleCopCheckInPolicy.UI.Forms.EditPolicyDialog"/> class.
        /// </summary>
