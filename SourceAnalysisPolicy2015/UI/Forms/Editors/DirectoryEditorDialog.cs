//--------------------------------------------------------------------------
// <copyright file="DirectoryEditorDialog.cs" company="Ralph Jansen">
...
namespace RalphJansen.StyleCopCheckInPolicy.UI.Forms.Editors
{
    ...
    using RalphJansen.StyleCopCheckInPolicy.Policy.Exclusions.FileSystem;
    ...
    internal sealed partial class DirectoryEditorDialog : BasePathEditorDialog
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RalphJansen.StyleCopCheckInPolicy.UI.Forms.Editors.DirectoryEditorDialog"/> class.
        /// </summary>
