//--------------------------------------------------------------------------
// <copyright file="WorkItemFieldEditorDialog.cs" company="Ralph Jansen">
...
namespace RalphJansen.StyleCopCheckInPolicy.UI.Forms.Editors
{
    ...
    using RalphJansen.StyleCopCheckInPolicy.Policy.Exclusions.WorkItem;
    ...
    internal sealed partial class WorkItemFieldEditorDialog : BaseEditorDialog
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RalphJansen.StyleCopCheckInPolicy.UI.Forms.Editors.WorkItemFieldEditorDialog"/> class.
        /// </summary>
