//--------------------------------------------------------------------------
// <copyright file="BaseDialog.cs" company="Ralph Jansen">
...
namespace RalphJansen.StyleCopCheckInPolicy.UI.Forms.Design
{
    ...
    internal partial class BaseDialog : BaseForm
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RalphJansen.StyleCopCheckInPolicy.UI.Forms.Design.BaseDialog"/> class.
        /// </summary>
        public BaseDialog()
        {
