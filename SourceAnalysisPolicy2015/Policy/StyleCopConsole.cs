//--------------------------------------------------------------------------
// <copyright file="StyleCopConsole.cs" company="Ralph Jansen">
...
namespace RalphJansen.StyleCopCheckInPolicy.Policy
{
    ...
    internal sealed class StyleCopConsole : IDisposable
    {
        ...
        /// <summary>
        /// Finalizes an instance of the <see cref="RalphJansen.StyleCopCheckInPolicy.Policy.StyleCopConsole"/> class.
        /// </summary>
        ~StyleCopConsole()
        {
            this.Dispose(false);
        ...
        public void Analyze(IList<CodeProject> projects)
        {
            if (projects == null)
            {
                ThrowHelper.ThrowArgumentNullException("projects");
            }
