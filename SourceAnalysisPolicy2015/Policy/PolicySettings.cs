//--------------------------------------------------------------------------
// <copyright file="PolicySettings.cs" company="Ralph Jansen">
...
namespace RalphJansen.StyleCopCheckInPolicy.Policy
{
    ...
    internal sealed class PolicySettings : ICloneable
    {
        ...
        /// <summary>
        /// Prevents a default instance of the <see cref="RalphJansen.StyleCopCheckInPolicy.Policy.PolicySettings"/> class from being created.
        /// </summary>
