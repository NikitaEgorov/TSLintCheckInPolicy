//--------------------------------------------------------------------------
// <copyright file="FilePolicyExclusion.cs" company="Ralph Jansen">
...
namespace RalphJansen.StyleCopCheckInPolicy.Policy.Exclusions.FileSystem
{
    ...
    internal sealed class FilePolicyExclusion : PathPolicyExclusion
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RalphJansen.StyleCopCheckInPolicy.Policy.Exclusions.FileSystem.FilePolicyExclusion"/> class.
        /// </summary>
