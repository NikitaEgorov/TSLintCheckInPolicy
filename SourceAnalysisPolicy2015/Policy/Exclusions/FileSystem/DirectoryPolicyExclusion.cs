//--------------------------------------------------------------------------
// <copyright file="DirectoryPolicyExclusion.cs" company="Ralph Jansen">
...
namespace RalphJansen.StyleCopCheckInPolicy.Policy.Exclusions.FileSystem
{
    ...
    internal sealed class DirectoryPolicyExclusion : PathPolicyExclusion
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RalphJansen.StyleCopCheckInPolicy.Policy.Exclusions.FileSystem.DirectoryPolicyExclusion"/> class.
        /// </summary>
