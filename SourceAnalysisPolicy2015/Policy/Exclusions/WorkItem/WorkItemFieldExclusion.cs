//--------------------------------------------------------------------------
// <copyright file="WorkItemFieldExclusion.cs" company="Ralph Jansen">
...
namespace RalphJansen.StyleCopCheckInPolicy.Policy.Exclusions.WorkItem
{
    ...
    internal sealed class WorkItemFieldExclusion : WorkItemExclusion
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RalphJansen.StyleCopCheckInPolicy.Policy.Exclusions.WorkItem.WorkItemFieldExclusion"/> class.
        /// </summary>
