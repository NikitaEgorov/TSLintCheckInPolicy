//--------------------------------------------------------------------------
// <copyright file="WorkItemIdExclusion.cs" company="Ralph Jansen">
...
namespace RalphJansen.StyleCopCheckInPolicy.Policy.Exclusions.WorkItem
{
    ...
    internal sealed class WorkItemIdExclusion : WorkItemExclusion
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RalphJansen.StyleCopCheckInPolicy.Policy.Exclusions.WorkItem.WorkItemIdExclusion"/> class.
        /// </summary>
