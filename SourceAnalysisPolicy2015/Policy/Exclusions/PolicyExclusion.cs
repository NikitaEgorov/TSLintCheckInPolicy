//--------------------------------------------------------------------------
// <copyright file="PolicyExclusion.cs" company="Ralph Jansen">
...
namespace RalphJansen.StyleCopCheckInPolicy.Policy.Exclusions
{
    ...
    internal abstract class PolicyExclusion
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RalphJansen.StyleCopCheckInPolicy.Policy.Exclusions.PolicyExclusion"/> class.
        /// </summary>
