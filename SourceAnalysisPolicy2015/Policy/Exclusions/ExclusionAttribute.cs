//--------------------------------------------------------------------------
// <copyright file="ExclusionAttribute.cs" company="Ralph Jansen">
...
namespace RalphJansen.StyleCopCheckInPolicy.Policy.Exclusions
{
    ...
    internal sealed class ExclusionAttribute : Attribute
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RalphJansen.StyleCopCheckInPolicy.Policy.Exclusions.ExclusionAttribute"/> class.
        /// </summary>
